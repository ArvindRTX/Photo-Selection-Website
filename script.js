                ...
                setTimeout(() => {
                    ...
                    const loadImage = () => {
                        ...
                        img.onload = () => {
                            ...
                            if (container.querySelector('.loader')) container.querySelector('.loader').style.display = 'none';
                        };
                        img.onerror = () => {
    ...
    form.addEventListener('submit', async (event) => {
        ...
        try {
            const response = await fetch('/submit', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({ clientName, clientEmail, clientPhone, selectedPhotos: selections }),
            });
            if (response.ok) {
